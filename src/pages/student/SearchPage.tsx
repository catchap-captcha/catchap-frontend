...
const FALLBACK: SearchItem[] = [
  ...
  { title: '역사', tag: '과목', desc: '옛날 이야기와 지혜를 만나는 역사 한 판', icon: 'ph-fill ph-scroll', bg: '#EDE6FF', color: '#8B6BFF', href: 'CatChap 안전지킴이.dc.html', kw: '역사 이야기 옛날 hist' },
