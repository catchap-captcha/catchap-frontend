        ...
        <div className="ta-row1">
          ...
          <div className="ta-card">
            ...
            <svg viewBox="0 0 640 232" className="ta-chart">
              ...
              <text x={622} y={chart.avgLabelY} textAnchor="end" fontSize={11.5} fontWeight={800} fill="#E0940A">{chart.avgLabel}</text>
              ...
              {chart.points.map((p, i) => (
                <g key={i}>
                  ...
                  <text x={p.cx} y={p.ly} textAnchor="middle" fontSize={12.5} fontWeight={800} fill={p.fill}>{p.label}</text>
                </g>
              ))}
            </svg>
